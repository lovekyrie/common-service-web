...
export default {
    ...
    typeName: {
      ...
      set(value) {
        if (this.selectedType) {
          this.$emit('updateType', { ...this.selectedType, name: value })
        }
      },
    },
    typeCode: {
      ...
      set(value) {
        if (this.selectedType) {
          this.$emit('updateType', { ...this.selectedType, code: value })
        }
      },
    },
    typeDescription: {
      ...
      set(value) {
        if (this.selectedType) {
          this.$emit('updateType', { ...this.selectedType, description: value })
        }
      },
    },
  },
  methods: {
    ...
    saveChanges() {
      ...
      this.$emit('saveChanges', this.selectedType)
      this.$message.success('保存成功')
    },

    cancelChanges() {
      if (this.selectedType) {
        this.$emit('cancelChanges', this.selectedType)
      }
    ...
    addNewField() {
      ...
      this.$emit('addField', { type: this.selectedType, field: newField })
    },
    ...
    deleteField(field) {
      ...
      this.$confirm('确定要删除这个字段吗？', '提示', {
        ...
        this.$emit('deleteField', { type: this.selectedType, field })
